...
(`scripts/*.test.js`: auth-guard/access/routing/sync/exam-audio/exam-resume/data-phase2/band-score/grade-sections/skills/plan-charge/writing-models/vocab-session/weakest-section/focus-restore/focus-hooks/toggle-a11y — 18 files, 145 tests) plus Deno for the edge functions
