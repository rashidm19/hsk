...
(`scripts/*.test.js`: auth-guard/access/routing/sync/exam-audio/exam-resume/data-phase2/band-score/grade-sections/skills/plan-charge/writing-models/vocab-session/weakest-section — 15 files, 124 tests) plus Deno for the edge functions
