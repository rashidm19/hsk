...
(function () {
  ...
  function menuHtml(s) {
    ...
    return '<h1 style="margin:0 0 16px;font-size:1.5rem;font-weight:700;letter-spacing:-.02em;color:var(--ink)">More <span class="serif-cn" style="color:var(--accent);font-weight:400;font-size:.62em">更多</span></h1>' +
      ...
      '<div style="flex:1;min-width:0"><div style="font-weight:700;color:var(--ink);font-size:1.05rem">' + esc(pv.name) + '</div><div style="font-size:.82rem;color:var(--stone);white-space:nowrap;overflow:hidden;text-overflow:ellipsis">' + esc(pv.email) + '</div></div>' +
      CHEV_R + '</button>' +
  ...
  function profileHtml(s) {
    ...
    return backBtn('backToMore', 'More') +
      ...
      '<div style="flex:1;min-width:0"><div style="font-weight:700;color:var(--ink);font-size:1.1rem">' + esc(pv.name) + '</div><div style="font-size:.82rem;color:var(--stone);white-space:nowrap;overflow:hidden;text-overflow:ellipsis">' + esc(pv.email) + '</div></div>' +
  ...
  function profileSheetHtml(s) {
    ...
    return '<div style="position:absolute;inset:0;z-index:80">' +
      ...
      '<label style="display:block;margin-bottom:14px"><span style="display:block;font-size:.78rem;font-weight:600;color:var(--ink);margin-bottom:7px">Email</span><input type="email" value="' + esc(draft.email) + '" disabled style="width:100%;box-sizing:border-box;border:1px solid var(--border-subtle);background:var(--surface-sunken);border-radius:12px;padding:13px 14px;font-size:.95rem;color:var(--stone);outline:none;opacity:.7"><span style="display:block;font-size:.72rem;color:var(--stone);margin-top:5px">Contact support to change email</span></label>' +
      '<label style="display:block;margin-bottom:20px"><span style="display:block;font-size:.78rem;font-weight:600;color:var(--ink);margin-bottom:7px">Country</span><input type="text" value="' + esc(draft.country) + '" data-in="onDraftCountry" style="width:100%;box-sizing:border-box;border:1px solid var(--border-subtle);background:var(--surface-sunken);border-radius:12px;padding:13px 14px;font-size:.95rem;color:var(--ink);outline:none"></label>' +
