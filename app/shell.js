  ...
  function welcomeHtml(s) {
    ...
    if (step === 0) {
      ...
      body = '<div style="padding:20px 22px;animation:hsk-up .35s ease both">'
        ...
        + '<div style="display:flex;align-items:center;gap:13px;padding:15px 14px;border-bottom:1px solid var(--border-subtle)"><span class="chinese" style="width:42px;height:42px;flex:none;display:grid;place-items:center;background:var(--jade-soft);color:var(--jade);border-radius:12px;font-size:20px">词</span><div style="flex:1"><div style="font-weight:600;color:var(--ink);font-size:.95rem">1,000-word bank</div><div style="font-size:.82rem;color:var(--stone)">Swipe flashcards · mark what you know</div></div></div>'
