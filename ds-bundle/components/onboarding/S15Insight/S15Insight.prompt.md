...
Screen 15 of the HSK Prep onboarding funnel (`/quiz/`). A short insight interstitial before the plan reveal.
...
**Key classes on this screen:** `.ob-app`, `.ob-back`, `.ob-brand`, `.ob-brand-mark`, `.ob-brand-name`, `.ob-cta`, `.ob-foot`, `.ob-h1`, `.ob-progress`, `.ob-progress-bar`, `.ob-quote`, `.ob-quote-name`, `.ob-quote-text`, `.ob-result-hl`, `.ob-screen`, `.ob-stage`, `.ob-stars`, `.ob-step-count`, `.ob-summary`, `.ob-summary-row`, `.ob-top`, `.ob-top-row`
