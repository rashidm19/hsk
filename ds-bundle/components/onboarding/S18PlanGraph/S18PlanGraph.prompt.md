# Onboarding · Plan graph

Screen 18 of the HSK Prep onboarding funnel (`/quiz/`). The plan reveal: an SVG line chart projecting the path from "now" to the target level.
...
**Key classes on this screen:** `.ob-app`, `.ob-back`, `.ob-brand`, `.ob-brand-mark`, `.ob-brand-name`, `.ob-cta`, `.ob-foot`, `.ob-growth`, `.ob-growth-area`, `.ob-growth-cap`, `.ob-growth-dot`, `.ob-growth-lbl`, `.ob-growth-line`, `.ob-growth-svg`, `.ob-h1`, `.ob-progress`, `.ob-progress-bar`, `.ob-screen`, `.ob-stage`, `.ob-step-count`, `.ob-sub`, `.ob-top`, `.ob-top-row`
