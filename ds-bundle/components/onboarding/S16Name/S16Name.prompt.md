...
Screen 16 of the HSK Prep onboarding funnel (`/quiz/`). A single text-input screen collecting the learner’s name (with Skip).
...
**Key classes on this screen:** `.ob-app`, `.ob-back`, `.ob-brand`, `.ob-brand-mark`, `.ob-brand-name`, `.ob-cta`, `.ob-foot`, `.ob-h1`, `.ob-input`, `.ob-link`, `.ob-progress`, `.ob-progress-bar`, `.ob-screen`, `.ob-stage`, `.ob-step-count`, `.ob-sub`, `.ob-top`, `.ob-top-row`
