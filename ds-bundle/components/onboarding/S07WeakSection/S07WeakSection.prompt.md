# Onboarding · Weak section

Screen 7 of the HSK Prep onboarding funnel (`/quiz/`). Single-select: which HSK section (Listening / Reading / Writing) is weakest.
...
**Key classes on this screen:** `.ob-app`, `.ob-back`, `.ob-brand`, `.ob-brand-mark`, `.ob-brand-name`, `.ob-foot`, `.ob-h1`, `.ob-opt`, `.ob-options`, `.ob-progress`, `.ob-progress-bar`, `.ob-screen`, `.ob-stage`, `.ob-step-count`, `.ob-sub`, `.ob-top`, `.ob-top-row`
