...
Screen 13 of the HSK Prep onboarding funnel (`/quiz/`). Intro card that hands off to the 5-question diagnostic (no login needed).
...
**Key classes on this screen:** `.ob-app`, `.ob-back`, `.ob-brand`, `.ob-brand-mark`, `.ob-brand-name`, `.ob-dq`, `.ob-dq-audio`, `.ob-dq-prog`, `.ob-foot`, `.ob-h1`, `.ob-opt`, `.ob-options`, `.ob-progress`, `.ob-progress-bar`, `.ob-screen`, `.ob-stage`, `.ob-step-count`, `.ob-sub`, `.ob-top`, `.ob-top-row`
