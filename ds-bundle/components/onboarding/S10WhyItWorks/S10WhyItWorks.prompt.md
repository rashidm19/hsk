# Onboarding · Why it works

Screen 10 of the HSK Prep onboarding funnel (`/quiz/`). An info screen: why the product works, with a highlighted pass-rate statistic.
...
**Key classes on this screen:** `.ob-app`, `.ob-back`, `.ob-brand`, `.ob-brand-mark`, `.ob-brand-name`, `.ob-bullets`, `.ob-cta`, `.ob-foot`, `.ob-h1`, `.ob-progress`, `.ob-progress-bar`, `.ob-screen`, `.ob-stage`, `.ob-stat`, `.ob-step-count`, `.ob-top`, `.ob-top-row`
