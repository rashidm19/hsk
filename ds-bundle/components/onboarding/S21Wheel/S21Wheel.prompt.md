# Onboarding · Reward wheel

Screen 21 of the HSK Prep onboarding funnel (`/quiz/`). A gamified reward wheel ("spin to unlock") offering a discount before the paywall.
...
**Key classes on this screen:** `.ob-app`, `.ob-back`, `.ob-brand`, `.ob-brand-mark`, `.ob-brand-name`, `.ob-center`, `.ob-cta`, `.ob-cta--lg`, `.ob-foot`, `.ob-h1`, `.ob-progress`, `.ob-progress-bar`, `.ob-screen`, `.ob-stage`, `.ob-step-count`, `.ob-sub`, `.ob-top`, `.ob-top-row`, `.ob-wheel`, `.ob-wheel-hub`, `.ob-wheel-pointer`, `.ob-wheel-wrap`
