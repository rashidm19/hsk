...
Screen 14 of the HSK Prep onboarding funnel (`/quiz/`). A processing / loading screen while the plan is "built"; auto-advances in production.
...
**Key classes on this screen:** `.ob-app`, `.ob-back`, `.ob-brand`, `.ob-brand-mark`, `.ob-brand-name`, `.ob-center`, `.ob-foot`, `.ob-h1`, `.ob-proc-dot`, `.ob-proc-step`, `.ob-proc-steps`, `.ob-progress`, `.ob-progress-bar`, `.ob-screen`, `.ob-spinner`, `.ob-stage`, `.ob-step-count`, `.ob-top`, `.ob-top-row`
