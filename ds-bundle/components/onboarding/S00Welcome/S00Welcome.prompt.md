...
Screen 0 of the HSK Prep onboarding funnel (`/quiz/`). The funnel entry / hero: brand logo, 5-star trust pill, headline and the "Start free assessment" CTA.
...
**Key classes on this screen:** `.ob-app`, `.ob-back`, `.ob-brand`, `.ob-brand-mark`, `.ob-brand-name`, `.ob-center`, `.ob-cta`, `.ob-cta--lg`, `.ob-foot`, `.ob-h1`, `.ob-logo`, `.ob-logo-mark`, `.ob-logo-name`, `.ob-pill`, `.ob-progress`, `.ob-progress-bar`, `.ob-screen`, `.ob-stage`, `.ob-step-count`, `.ob-sub`, `.ob-top`, `.ob-top-row`
