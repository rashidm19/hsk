...
Screen 17 of the HSK Prep onboarding funnel (`/quiz/`). The auth gate: email entry, one-time-code, and Google sign-in to unlock the plan.
...
**Key classes on this screen:** `.ob-app`, `.ob-back`, `.ob-bonus`, `.ob-brand`, `.ob-brand-mark`, `.ob-brand-name`, `.ob-cta`, `.ob-error`, `.ob-foot`, `.ob-google`, `.ob-h1`, `.ob-input`, `.ob-note`, `.ob-or`, `.ob-progress`, `.ob-progress-bar`, `.ob-screen`, `.ob-stage`, `.ob-step-count`, `.ob-sub`, `.ob-top`, `.ob-top-row`
