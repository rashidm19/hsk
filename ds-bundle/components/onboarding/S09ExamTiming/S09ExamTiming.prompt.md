# Onboarding · Exam timing

Screen 9 of the HSK Prep onboarding funnel (`/quiz/`). Single-select: the learner’s planned exam timeframe.
...
**Key classes on this screen:** `.ob-app`, `.ob-back`, `.ob-brand`, `.ob-brand-mark`, `.ob-brand-name`, `.ob-foot`, `.ob-h1`, `.ob-opt`, `.ob-options`, `.ob-progress`, `.ob-progress-bar`, `.ob-screen`, `.ob-stage`, `.ob-step-count`, `.ob-top`, `.ob-top-row`
